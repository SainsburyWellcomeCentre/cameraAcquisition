...
WORKFLOW    = r"C:\Users\harrislab\cameraAcquisition\BehaviourCamerasAcquisitionFM.bonsai"
...
def build_paths(subject, protocol):
    ...
    session_dir = os.path.join(BASE_DIR, subject, "luminose_fm_videos", "Session Videos")
